...
public class NeoStore extends AbstractStore
{
                    ...
                    RelationshipGroupStore relGroupStore )
    {
        ...
        SUPER_NODE_THRESHOLD = DEFAULT_SUPER_NODE_THRESHOLD; //getIntFromConfig( config, Config.SUPER_NODE_THRESHOLD, DEFAULT_SUPER_NODE_THRESHOLD );
        this.txHook = txHook;
    ...
    public void flushAll()
    {
        if ( relTypeStore == null || propStore == null || relStore == null ||
                nodeStore == null || relGroupStore == null )
        {
            return;
        }
    ...
    public boolean isStoreOk()
    {
        return getStoreOk() && relTypeStore.getStoreOk() &&
            propStore.getStoreOk() && relStore.getStoreOk() && nodeStore.getStoreOk() && relGroupStore.getStoreOk();
    }
